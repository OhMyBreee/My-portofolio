...
export function AnimatedListDemo({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "absolute inset-0 flex h-[400px] w-full flex-col overflow-hidden p-2",
        // "fixed bottom-4 right-4 flex h-[400px] w-[300px] flex-col overflow-hidden p-2 z-50",
        className
      )}
    >
      <AnimatedList>
